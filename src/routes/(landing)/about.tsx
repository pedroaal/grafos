					...
					<div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
						...
						<div>
							...
							<p class="text-gray-600 text-justify mb-6 leading-relaxed">
								...
								convertido en una empresa sólida y creciente en el área gráfica,
								preocupados siempre por mejorar nuestros procesos a fin de
								entregar un servicio de alta calidad, de acuerdo a las
								exigencias del mercado actual.
							</p>
							<p class="text-gray-600 text-justify mb-6 leading-relaxed">
								La experiencia de nuestro personal y su permanente capacitación
								nos han mantenido siempre actualizados en el constante avance
								tecnológico.
							</p>
